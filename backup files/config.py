...
Enhanced with Session-Based Workflow
"""
import os
...
class Config:
    ...
    # Complete Uganda National Curriculum Subjects
    SUBJECTS = [
        # Core Subjects
        'English Language',
    ...
    EXAM_TYPES = ['Midterm', 'End of Term', 'Mock', 'National', 'Practice']
